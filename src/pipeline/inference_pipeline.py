...
class InferencePipeline:
    ...
    def __init__(self, config_path: str = str(Path("configs/inference_pipeline.yaml"))):
        try:
            ...
            self.model_path = infer_cfg.get("model_path", "artifacts/best_model/best.h5")
            self.clean_config_path = infer_cfg.get("clean_config_path", "configs/config.yaml")
            ...
            logger.info(f"✅ InferencePipeline initialized successfully with model: {self.model_path}")
